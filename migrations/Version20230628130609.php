...
final class Version20230628130609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE characteristic (id INT AUTO_INCREMENT NOT NULL, reseau VARCHAR(255) NOT NULL, stockage VARCHAR(255) NOT NULL, ecran VARCHAR(255) NOT NULL, ram VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
